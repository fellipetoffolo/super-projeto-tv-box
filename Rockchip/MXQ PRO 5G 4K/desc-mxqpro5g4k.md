# <img src="https://github.com/fellipetoffolo/super-projeto-tv-box/blob/Cortella/.assets/mxqpro-box.png" alt="Imagem do case" width="30"/> Descaracterização do modelo MXQ Pro
...
Verifique as especificações completas de hardware da MXQ Pro [aqui](https://github.com/fellipetoffolo/super-projeto-tv-box/blob/main/informacoes-modelos-e-hardwares.md#rpc-mini).

### Imagem do modelo

<img src="https://github.com/fellipetoffolo/super-projeto-tv-box/blob/Cortella/.assets/mxqpro-box.png" alt="Imagem do case" width="300"/>
<img src="https://github.com/fellipetoffolo/super-projeto-tv-box/blob/Cortella/.assets/mxqpro-placa.png" alt="Imagem do Hardware" width="300"/>
...
- Cartão SD: utilizado para gravar o sistema operacional Armbian na MXQ Pro.
- Monitor, teclado, mouse e cabo HDMI: utilizado para interagir com a MXQ Pro.

### Software

- Balena Etcher, Rufus ou dd: utilizado para gravar o multitool no cartão SD.
- Multitool: utilizado para gravar o sistema operacional Armbian no armazenamento interno da MXQ Pro. 
...
- Sempre selecione "Shutdown" ao desligar a MXQ Pro com multitool iniciado.
...
2. Redimensione as partições do multitool. Para isso:
   ...
   - Insira na MXQ Pro e ligue-a.
   - Desligue a MXQ Pro e insira o cartão SD no computador/notebook novamente.
3. Copiar imagem do Armbian para o diretório "images" no multitool.
4. Inserir cartão SD na MXQ Pro e gravar a imagem do Armbian no armazenamento interno da MXQ Pro.
   - OPCIONAL: realizar backup da imagem original da MXQ Pro.
5. Ligar a MXQ Pro sem o cartão SD.
...
4. Insira o cartão SD na MXQ Pro e ligue-a.
5. Selecione a opção "Shutdown" e desligue a MXQ Pro.
...
1. Insira o cartão SD (já com multitool e a imagem do Armbian) na MXQ Pro e ligue-a.
2. Selecione a opção "Burn image to flash".
   - OPCIONAL: fazer backup da imagem original da MXQ Pro. Ao fazer backup, a imagem original será armazenada em "MULTITOOL/backup".
...
6. Após terminar, selecione "Shutdown" e desligue a MXQ Pro.
7. Remova o cartão SD da MXQ Pro.

### Configuração do Armbian

1. Ligue a MXQ Pro sem o cartão SD.
