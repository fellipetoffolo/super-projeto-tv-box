# <img src="../../.assets/redpro-perfil.png" alt="Imagem de perfil" width="30"/> Descaracterização do modelo RedPro2
...
|Box          | Circuito   |
|-------------|------------|
| <img src="../../.assets/redpro-box.png" alt="Imagem do modelo" width="300"/> | <img src="../../.assets/redpro-placa.png" alt="Imagem do circuito" width="300"/>

### Sistema operacional original

Android  9, kernel 4.9.113 (pré-instalado).

### Suporte de rede (módulo AMPAK AP6212 - driver brcmfmac4330-sdio)

⚠️ _Até o momento não foi obtido nenhum suporte para Wi-Fi, mas [discussões no fórum Armbian](https://forum.armbian.com/topic/16696-armbian-for-tanix-tx3-amlogic-s905x3-with-sp6330-wifibluetooth-module/) sugerem que ele pode ser configurado para esse modelo específico e semelhantes seguindo uma série de passos._

O módulo de rede identificado para esse modelo é o: **Ampak AP6212**, para o qual o driver correspondente ainda não foi corretamente identificado, mas está relacionado a uma configuração dos arquivos no diretório **lib/aarch-64/firmware/**.
