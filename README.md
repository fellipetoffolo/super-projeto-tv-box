...
#### &nbsp;&nbsp; O respositório foi organizado de forma que os dispositivos de mesmo SoC (System on Chip) estão agrupados no mesmo diretório. Para este projeto foram considerados três fabricantes de SoC: Amlogic, Rockchip e Allwinner.
